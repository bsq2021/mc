...
public class BananapickItem extends PAndBModElements.ModElement {
	@ObjectHolder("p_and_b:bananapick")
	public static final Item block = null;

	public BananapickItem(PAndBModElements instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("it banana lishes"));
			}
		}.setRegistryName("bananapick"));
	}
}
